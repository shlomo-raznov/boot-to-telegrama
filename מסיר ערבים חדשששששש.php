...
של מחיקת הודעות והסרת משתמשים בשביל שאני יסיר את המשתמשים הערביים
בקרוב ישיש שרות חדש 
שאם הטרידו אותכם אתם שולחים לי את הid שלו והוא נחמק מכל הקבוצות שהבוט נמצא 
קרדיט https://t.me/mohoyz


להוספת הרובוט לקבוצה [לחץ כאן](https://telegram.me/$grup?startgroup=new)


לכל בעיה פנה אלי - @LEVVVV12
",
'parse_mode' => 'Markdown',
